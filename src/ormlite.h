...
{
    // SQLConnector - Interface to Implement Database Driver
    class SQLConnector
    {
    public:
        ...
        virtual void ExecuteCallback(const std::string &cmd, std::function<void (int, char **)> callback) = 0;
    };
...
namespace BOT_ORM
{
    ...
    public:
        ORMapper(std::shared_ptr<BOT_ORM_Impl::SQLConnector> c) : _connector(c)
        {
